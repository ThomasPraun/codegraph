...
**What lives here** — 55 exported symbols across 9 files.

*Most depended on — changing one of these reaches furthest:*

- `OUT_DIR` · `scripts/lib/scan.mjs` — The one directory this skill writes into a project, and the only trace it leaves. Named after the skill so it… (7 uses)
